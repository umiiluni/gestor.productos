...
function exportarExcel() {
    ...
    const datosExportar = productos.map(p => ({
        ...
        'Fecha Actualización': p.fechaActualizacion ? new Date(p.fechaActualizacion).toLocaleString() : ''
    }));
    ...
    SistemaBazar.mostrarMensaje('exito', 'Archivo Excel generado correctamente');
}
